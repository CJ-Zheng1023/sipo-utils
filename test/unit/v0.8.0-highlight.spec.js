...
describe('v0.8.0-alpha版本高亮基础功能测试', () => {
  ...
  test('基本功能测试3，高亮关键词为尖括号的情况', () => {
    ...
    const tobe = `响应于一个触发信号提供一个地电位的第<span class="hl" style="background-color: red;color: #000;">&lt;</span>一装置`
    expect(utils.highlight(targetStr, highlighters)).toBe(tobe)
  })
  test('基本功能测试4，高亮关键词为正则特殊字符的情况', () => {
    ...
    const tobe = `响应于一个触发信号提供一个地电位的第一装置<span class="hl" style="background-color: red;color: #000;">.</span>`
    expect(utils.highlight(targetStr, highlighters)).toBe(tobe)
  })
})
describe('v0.8.0-alpha版本高亮截词符测试', () => {
  test('截词符测试1', () => {
    ...
    const tobe = `响应于一个触发信号提供一个地电位的第一<span class="hl" style="background-color: red;color: #000;">装</span><span class="hl" style="background-color: red;color: #000;">置</span><span class="hl" style="background-color: red;color: #000;">a</span>`
